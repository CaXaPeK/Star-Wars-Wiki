...
struct Vehicle: Codable {
    ...
    let starship_class, vehicle_class: String?
    let pilots, films: [String]?
    let created, edited: String?
    let url: String?
}

let defaultVehicle = Vehicle(name: nil, model: nil, manufacturer: nil, cost_in_credits: nil, length: nil, max_atmosphering_speed: nil, crew: nil, passengers: nil, cargo_capacity: nil, consumables: nil, hyperdrive_rating: nil, mglt: nil, starship_class: nil, vehicle_class: nil, pilots: nil, films: nil, created: nil, edited: nil, url: nil)
